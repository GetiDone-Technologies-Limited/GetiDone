...
export default function ProjectWorkspacePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="flex flex-col xl:flex-row gap-8 w-full max-w-[1600px] mx-auto">
      ...
      <div className="w-full xl:w-[420px] shrink-0 flex flex-col gap-6 pt-7">
        
        {/* Projects Summary */}
        <div className="bg-white rounded-3xl border border-slate-200 p-7 shadow-sm">
          <div className="flex justify-between items-center mb-8">
            <h3 className="text-base font-bold text-slate-900">Projects Summary</h3>
            <select className="text-[13px] font-bold text-slate-600 bg-slate-50 border border-slate-200 rounded-xl px-3 py-1.5 outline-none hover:bg-slate-100 transition-colors cursor-pointer">
          ...
          <div className="grid grid-cols-4 gap-3 mb-8">
            <div className="flex flex-col">
              <p className="text-[11px] font-bold text-slate-400 mb-1 uppercase tracking-wider">Total Projects</p>
              <p className="text-2xl font-black text-slate-900">18</p>
            </div>
            <div className="flex flex-col">
              <p className="text-[11px] font-bold text-slate-400 mb-1 uppercase tracking-wider">Active</p>
              <p className="text-2xl font-black text-slate-900">7</p>
            </div>
            <div className="flex flex-col">
              <p className="text-[11px] font-bold text-slate-400 mb-1 uppercase tracking-wider">In Review</p>
              <p className="text-2xl font-black text-blue-500">3</p>
            </div>
            <div className="flex flex-col">
              <p className="text-[11px] font-bold text-slate-400 mb-1 uppercase tracking-wider">Completed</p>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-5 rounded-2xl border border-slate-100 bg-slate-50">
              <p className="text-[12px] font-bold text-slate-500 mb-1.5">Total Spent</p>
              <p className="text-2xl font-black text-slate-900 mb-1.5">$48,250</p>
              <p className="text-[11px] font-bold text-[#00b259] flex items-center gap-1 mb-4">+12% <span className="text-slate-400 font-medium">from last month</span></p>
              <svg className="w-full h-10" viewBox="0 0 100 30" preserveAspectRatio="none">
                <path d="M0,25 C10,20 20,25 30,15 C40,5 50,15 60,10 C70,5 80,10 90,0 L100,5" fill="none" stroke="#00b259" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
            <div className="p-5 rounded-2xl border border-slate-100 bg-slate-50">
              <p className="text-[12px] font-bold text-slate-500 mb-1.5">Average Progress</p>
              <p className="text-2xl font-black text-slate-900 mb-1.5">67%</p>
              <p className="text-[11px] font-bold text-[#00b259] flex items-center gap-1 mb-4">+8% <span className="text-slate-400 font-medium">from last month</span></p>
              <svg className="w-full h-10" viewBox="0 0 100 30" preserveAspectRatio="none">
                <path d="M0,20 C10,15 20,20 30,10 C40,0 50,10 60,15 C70,20 80,10 90,15 L100,10" fill="none" stroke="#00b259" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl border border-slate-200 p-7 shadow-sm">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-base font-bold text-slate-900">Other Active Projects</h3>
            <button className="text-[13px] font-bold text-[#00b259] hover:underline">View All</button>
          </div>
          
          <div className="flex gap-2 mb-6 overflow-x-auto custom-scrollbar pb-2">
            <button className="px-4 py-1.5 text-[13px] font-bold text-white bg-[#00b259] rounded-full whitespace-nowrap shadow-sm">All</button>
            <button className="px-4 py-1.5 text-[13px] font-bold text-slate-600 bg-slate-100 rounded-full hover:bg-slate-200 transition-colors whitespace-nowrap">Active</button>
            <button className="px-4 py-1.5 text-[13px] font-bold text-slate-600 bg-slate-100 rounded-full hover:bg-slate-200 transition-colors whitespace-nowrap">In Review</button>
            <button className="px-4 py-1.5 text-[13px] font-bold text-slate-600 bg-slate-100 rounded-full hover:bg-slate-200 transition-colors whitespace-nowrap">Pending</button>
          </div>

          <div className="space-y-6">
            {/* Project 1 */}
            <div className="flex items-center gap-4 group cursor-pointer">
              <div className="w-12 h-12 rounded-[14px] bg-blue-50 border border-blue-100 flex items-center justify-center text-blue-600 shrink-0 group-hover:scale-105 transition-transform">
                <ShoppingCart className="w-6 h-6" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-[15px] font-bold text-slate-900 truncate group-hover:text-blue-600 transition-colors">Mobile Banking App</p>
                <p className="text-[13px] font-medium text-slate-500 truncate">Daniel B.</p>
              </div>
              <div className="text-right shrink-0">
                <div className="flex items-center gap-2 justify-end mb-1.5">
                  <span className="text-[13px] font-bold text-slate-900">72%</span>
                </div>
                <p className="text-[11px] font-bold text-orange-500 bg-orange-50 px-2 py-0.5 rounded-md">Due in 5 days</p>
              </div>
              <div className="shrink-0 text-right ml-3 w-14">
                <p className="text-[15px] font-black text-slate-900">$4,200</p>
              </div>
              <button className="text-slate-400 hover:text-slate-700 hover:bg-slate-100 p-1.5 rounded-lg transition-colors ml-1">
                <MoreHorizontal className="w-5 h-5" />
              </button>
            </div>
            ...
            {/* Project 2 */}
            <div className="flex items-center gap-4 group cursor-pointer">
              <div className="w-12 h-12 rounded-[14px] bg-purple-50 border border-purple-100 flex items-center justify-center text-purple-600 shrink-0 group-hover:scale-105 transition-transform">
                <Briefcase className="w-6 h-6" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-[15px] font-bold text-slate-900 truncate group-hover:text-purple-600 transition-colors">Company Website Redesign</p>
                <p className="text-[13px] font-medium text-slate-500 truncate">Esther O.</p>
              </div>
              <div className="text-right shrink-0">
                <div className="flex items-center gap-2 justify-end mb-1.5">
                  <span className="text-[13px] font-bold text-slate-900">35%</span>
                </div>
                <p className="text-[11px] font-bold text-orange-500 bg-orange-50 px-2 py-0.5 rounded-md">Due in 12 days</p>
              </div>
              <div className="shrink-0 text-right ml-3 w-14">
                <p className="text-[15px] font-black text-slate-900">$1,800</p>
              </div>
              <button className="text-slate-400 hover:text-slate-700 hover:bg-slate-100 p-1.5 rounded-lg transition-colors ml-1">
                <MoreHorizontal className="w-5 h-5" />
              </button>
